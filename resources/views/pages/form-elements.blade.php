...
<html lang="en">
    <head>
        ...
        <title>Form Elements | TailAdmin - Tailwind CSS Admin Dashboard Template</title>
    </head>
                ...
                <main>
                    <div class="mx-auto max-w-(--breakpoint-2xl) p-4 md:p-6">
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            <div class="space-y-6">
                                <div
                                    class="bg-white border border-gray-200 rounded-2xl dark:border-gray-800 dark:bg-white/5"
                                >
                                        ...
                                        <div>
                                            ...
                                            <div x-data="{ showPassword: false }" class="relative">
                                                ...
                                                <span
                                                    ...
                                                    class="absolute z-30 -translate-y-1/2 cursor-pointer top-1/2 right-4"
                                                >
                                                    <svg
                                                        x-show="!showPassword"
                                    ...
                                    <div class="p-5 space-y-6 border-t border-gray-100 sm:p-6 dark:border-gray-800">
                                        ...
                                        <div>
                                            ...
                                            >
                                                ...
                                                <span
                                                    class="absolute z-30 text-gray-700 -translate-y-1/2 pointer-events-none top-1/2 right-4 dark:text-gray-400"
                                                >
                                                    <svg
                                                        class="stroke-current"
                                                        width="20"
                                                        ...
                                                        <div class="relative flex flex-col items-center">
                                                                ...
                                                                >
                                                                    <div class="flex flex-wrap flex-auto gap-2">
                                                                        ...
                                                                        >
                                                                            <input
                                                                                ...
                                                                                class="w-full h-full p-1 pr-2 text-sm bg-transparent border-0 appearance-none outline-hidden placeholder:text-gray-800 focus:border-0 focus:ring-0 focus:outline-hidden dark:placeholder:text-white/90"
                                                                    ...
                                                                    <div class="flex items-center py-1 pl-1 pr-1 w-7">
                                                                        <button
                                                                            type="button"
                                                                            @click="open"
                                                                            class="w-5 h-5 text-gray-700 cursor-pointer outline-hidden focus:outline-hidden dark:text-gray-400"
                                                            ...
                                                            <div class="w-full px-4">
                                                                <div
                                                                    ...
                                                                    class="absolute left-0 z-40 w-full overflow-y-auto bg-white rounded-lg shadow-sm max-h-select top-full dark:bg-gray-900"
                                                                    @click.outside="close"
                                                                >
                                                                    <div class="flex flex-col w-full">
                                                                        ...
                                                                        >
                                                                            <div>
                                                                                <div
                                                                                    class="w-full border-b border-gray-200 rounded-t cursor-pointer hover:bg-primary/5 dark:border-gray-800"
                            ...
                            <div class="space-y-6">
                                ...
                                >
                                    ...
                                    <div class="p-5 space-y-6 border-t border-gray-100 sm:p-6 dark:border-gray-800">
                                        <!-- Elements -->
                                        <div class="flex flex-wrap items-center gap-6 mb-6 sm:gap-8">
                                            <div x-data="{ switcherToggle: false }">
                                                ...
                                                >
                                                    <div class="relative">
                                                        ...
                                                        />
                                                        <div
                                                            class="block h-6 rounded-full w-11"
                                ...
                                'bg-gray-200 dark:bg-white/10'"
                                            ...
                                            <div x-data="{ switcherToggle: false }">
                                                <label
                                                    for="toggle3"
                                                    class="flex items-center gap-3 text-sm font-medium text-gray-400 cursor-pointer select-none"
                                                >
                                                    <div class="relative">
                                                        <input
                                                            type="checkbox"
                                            ...
                                            <div x-data="{ switcherToggle: false }">
                                                ...
                                                >
                                                    <div class="relative">
                                                        ...
                                                        />
                                                        <div
                                                            class="block h-6 bg-gray-700 rounded-full w-11 dark:bg-white/10"
                                                        ></div>
                                                        <div
                                                            :class="switcherToggle ? 'translate-x-full' : 'translate-x-0'"
                                                            class="shadow-theme-sm absolute top-0.5 left-0.5 h-5 w-5 rounded-full bg-white duration-300 ease-linear"
                                            ...
                                            <div x-data="{ switcherToggle: false }">
                                                ...
                                                >
                                                    <div class="relative">
                                                        ...
                                                        />
                                                        <div
                                                            class="block h-6 bg-gray-100 rounded-full w-11 dark:bg-gray-800"
                                                        ></div>
                                                        <div
                                                            :class="switcherToggle ? 'translate-x-full' : 'translate-x-0'"
                                                            class="shadow-theme-sm absolute top-0.5 left-0.5 h-5 w-5 rounded-full bg-gray-50 duration-300 ease-linear"
                                ...
                                >
                                    <div class="px-5 py-4 sm:px-6 sm:py-5">
                                        <h3 class="text-base font-medium text-gray-800 dark:text-white/90">Dropzone</h3>
                                    </div>
                                    <div class="p-5 space-y-6 border-t border-gray-100 sm:p-6 dark:border-gray-800">
                                        <form
