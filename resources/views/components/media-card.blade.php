<div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/5">
    ...
    <div class="p-4 border-t border-gray-100 dark:border-gray-800 sm:p-6">
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6 xl:grid-cols-3">
            <!-- Media item-->
            <div
                class="flex items-center justify-between rounded-2xl border border-gray-100 bg-white py-4 pl-4 pr-4 dark:border-gray-800 dark:bg-white/5 xl:pr-5"
            >
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <span class="block text-sm text-gray-500 dark:text-gray-400">17% Used</span>
                    </div>
                </div>

                <div>
                    <span class="block mb-1 text-sm text-right text-gray-500 dark:text-gray-400">245 files</span>
                    <span class="block text-sm text-right text-gray-500 dark:text-gray-400">26.40 GB</span>
                </div>
            </div>
            ...
            >
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h4 class="mb-1 text-sm font-medium text-gray-800 dark:text-white/90">Videos</h4>
                        <span class="block text-sm text-gray-500 dark:text-gray-400">22% Used</span>
                    </div>
                </div>
            ...
            >
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h4 class="mb-1 text-sm font-medium text-gray-800 dark:text-white/90">Audio</h4>
                        <span class="block text-sm text-gray-500 dark:text-gray-400">24% Used</span>
                    </div>
                </div>
            ...
            >
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <span class="block text-sm text-gray-500 dark:text-gray-400">46% Used</span>
                    </div>
                </div>
            ...
            >
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h4 class="mb-1 text-sm font-medium text-gray-800 dark:text-white/90">Docs</h4>
                        <span class="block text-sm text-gray-500 dark:text-gray-400">18% Used</span>
                    </div>
                </div>
            ...
            >
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <span class="block text-sm text-gray-500 dark:text-gray-400">16% Used</span>
                    </div>
                </div>
