        ...
        <div class="flex flex-col h-auto pr-3 overflow-y-auto custom-scrollbar">
            ...
            >
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <span class="block text-gray-500 text-theme-xs dark:text-gray-400">Spotify.com</span>
                    </div>
                </div>
            ...
            >
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="text-base font-semibold text-gray-800 dark:text-white/90">ABNB</h3>
                        <span class="block text-gray-500 text-theme-xs dark:text-gray-400">Airbnb, Inc</span>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <span
                        class="flex items-center justify-end gap-1 font-medium text-theme-xs text-error-600 dark:text-error-500"
                    >
                        <svg
                            class="fill-current"
                            width="12"
            ...
            >
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="text-base font-semibold text-gray-800 dark:text-white/90">ENVT</h3>
                        <span class="block text-gray-500 text-theme-xs dark:text-gray-400">Envato, Inc</span>
                    </div>
                </div>
            ...
            >
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="text-base font-semibold text-gray-800 dark:text-white/90">QIWI</h3>
                        <span class="block text-gray-500 text-theme-xs dark:text-gray-400">qiwi.com, Inc</span>
                    </div>
                </div>
            ...
            >
                ...
                <div>
                    <div>
                        <h4 class="mb-1 font-medium text-right text-gray-600 text-theme-sm dark:text-gray-400">
                            $13,895.00
                        </h4>
                    </div>

                    <span
                        class="flex items-center justify-end gap-1 font-medium text-theme-xs text-success-700 dark:text-success-500"
                    >
                        <svg
                            class="fill-current"
                            width="12"
