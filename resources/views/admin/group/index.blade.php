...
@section("title", "ADMIN | Data Kelompok")
            ...
            <div class="space-y-5 sm:space-y-6">
                ...
                >
                    <div class="flex flex-col gap-2 mb-4 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">Daftar Kelompok</h3>
                        </div>
                                    ...
                                    <tr>
                                            ...
                                            <div class="flex items-center">
                                                <div class="flex items-center gap-3">
                                                    <p
                                                        class="font-medium text-gray-800 text-theme-sm dark:text-white/90"
                                                    >
                                                        {{ $item->admin->no_tlp ?? "Tidak diatur" }}
                                                    </p>
                                                </div>
                                            </div>
                                        </td>
                                            ...
                                            <div class="flex items-center">
                                                <div class="flex items-center gap-3">
                                                    <p
                                                        class="font-medium text-gray-800 text-theme-sm dark:text-white/90"
                                                    >
                                                        {{ $item->village->nama ?? "Tidak diatur" }}
                                                    </p>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center gap-2">
                                                <a
                                                    href="{{ route("admin.groups.edit", $item->id) }}"
                                                ...
                                                <form
                                                    ...
                                                    action="{{ route("admin.groups.destroy", $item->id) }}"
                                                    method="POST"
                                                >
                                                    @csrf
                                                    @method("DELETE")
