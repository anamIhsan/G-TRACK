...
@section("title", "ADMIN | Data Kategori Umur")
            ...
            <div class="space-y-5 sm:space-y-6">
                ...
                >
                    <div class="flex flex-col gap-2 mb-4 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">Daftar Kategori Umur</h3>
                        </div>
                        ...
                        <div class="flex items-center gap-3">
                            <div class="flex items-center">
                                <a
                                    ...
                                    href="{{ route("admin.age_categories.create") }}"
                                >
                    ...
                    <div class="w-full overflow-x-auto">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center gap-2">
                                                <a
                                                    href="{{ route("admin.age_categories.edit", $item->id) }}"
                                                ...
                                                <form
                                                    ...
                                                    action="{{ route("admin.age_categories.destroy", $item->id) }}"
                                                    method="POST"
                                                >
                                                    @csrf
                                                    @method("DELETE")
                        ...
                        <x-pagination :data="$ageCategories" />
                    </div>
                </div>
            </div>
        </div>
