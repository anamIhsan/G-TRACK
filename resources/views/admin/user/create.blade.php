...
@section('content')
    <div class="grid grid-cols-12 gap-4 md:gap-6">
        <form x-data="sectionForm()" x-init="init()" action="{{ route('admin.users.store') }}" method="POST"
                ...
                <div class="w-full bg-white border border-gray-200 rounded-2xl dark:border-gray-800 dark:bg-white/5">
                    ...
                    <div class="p-5 space-y-6 border-t border-gray-100 sm:p-6 dark:border-gray-800">
                        ...
                        <div>
                            ...
                            <input value="{{ old('nama') }}" name="nama" type="text" placeholder="Cth: Agus Hantono"
                        ...
                        <div>
                            ...
                            <input value="{{ old('nfc_id') }}" name="nfc_id" type="number" placeholder="Cth: 1092319232"
                                class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                        </div>
                        ...
                        <div>
                            ...
                            <div x-data="{ showPassword: false }" class="relative">
                                <input value="{{ old('password') }}" :type="showPassword ? 'text' : 'password'"
                        ...
                        <div>
                            ...
                            <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                                <select name="kelamin"
                                    ...
                                    <option {{ old('kelamin') === 'LK' ? 'selected' : '' }} value="LK"
                                        class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                        Laki-Laki
                                    </option>
                                    <option {{ old('kelamin') === 'PR' ? 'selected' : '' }} value="PR"
                                        class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                        Perempuan
                                    </option>
                                </select>
                        ...
                        <div>
                            ...
                            <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                                <select name="status_kawin"
                                    ...
                                    <option {{ old('status_kawin') === 'SUDAH' ? 'selected' : '' }} value="SUDAH"
                                        class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                        Sudah Menikah
                                    </option>
                                    <option {{ old('status_kawin') === 'BELUM' ? 'selected' : '' }} value="BELUM"
                                        class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                        Belum Menikah
                                    </option>
                                </select>
                            ...
                            <div>
                                ...
                                <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                                    <select name="zone_id"
                                        ...
                                        @change=" fetchInterests(); getWorks(); fetchMetafields(); isOptionSelected = true;">
