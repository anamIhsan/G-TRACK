            ...
            <div class="flex flex-col gap-2 space-y-5 sm:space-y-6">
                <div class="w-full bg-white border border-gray-200 rounded-2xl dark:border-gray-800 dark:bg-white/5">
                    <div class="px-5 py-4 sm:px-6 sm:py-5">
                        <h3 class="text-base font-medium text-gray-800 dark:text-white/90">Informasi Akun</h3>
                    </div>
                        ...
                        <div>
                            ...
                            <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                                ...
                                >
                                    ...
                                    <option
                                        {{ old("status_kawin") === "SUDAH" ? "selected" : "" }}
                                        value="SUDAH"
                                        class="text-gray-700 dark:bg-gray-900 dark:text-gray-400"
                                    >
                                        Sudah Menikah
                                    ...
                                    <option
                                        {{ old("status_kawin") === "BELUM" ? "selected" : "" }}
                                        value="BELUM"
                                        class="text-gray-700 dark:bg-gray-900 dark:text-gray-400"
                                    >
                                        Belum Menikah
                ...
                <div class="w-full bg-white border border-gray-200 rounded-2xl dark:border-gray-800 dark:bg-white/5">
                    ...
                    <div class="p-5 space-y-6 border-t border-gray-100 sm:p-6 dark:border-gray-800">
                            ...
                            <div>
                                ...
                                <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                                    <select
                                        ...
                                        :class="isOptionSelected && 'text-gray-800 dark:text-white/90'"
                                        x-model="zone_id"
                                        @change="getVillages(zone_id); fetchInterests(); getWorks(); fetchMetafields(); fetchCommunities(); isOptionSelected = true;"
                                    >
                                        <option
                                            class="text-gray-700 dark:bg-gray-900 dark:text-gray-400"
                                            disabled
                        ...
                        <div>
                            ...
                            <select
                                name="interest_id"
                                x-model="interestId"
                                @change="fetchSubInterests()"
                                :disabled="!zone_id"
                                class="w-full px-4 text-sm border border-gray-300 rounded-lg h-11 pr-11 disabled:bg-gray-100 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90"
                            >
                                <option class="text-gray-700 dark:bg-gray-900 dark:text-gray-400" disabled>
                                    -- Pilih Salah Satu --
                                </option>
                                <option selected value="" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                    Tidak diatur
                                </option>

                                <template x-for="interest in interests" :key="interest.id">
                                    <option :value="interest.id" x-text="interest.nama"></option>
                                </template>
                            </select>
                        </div>
                            ...
                            <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                                ...
                                >
                                    ...
                                    <template x-for="work in works" :key="work.id">
                                        <option :value="work.id" x-text="work.nama"></option>
                                    </template>
                                </select>
                                <span
                                    class="absolute z-30 text-gray-500 -translate-y-1/2 pointer-events-none top-1/2 right-4 dark:text-gray-400"
                            ...
                            <template x-if="metafield.type === 'STRING'">
                                <div>
                                    <label
                                        ...
                                        x-text="metafield.field"
                                    ></label>

                                    <input
                                        type="text"
                                        :name="`value[${metafield.id}]`"
                                        x-model="metafield.value"
                            ...
                            <template x-if="metafield.type !== 'STRING'">
                                <div>
                                    ...
                                    <select
                                        :name="`value[${metafield.id}]`"
                                        x-model="metafield.value"
                                        class="dark:bg-dark-900 shadow-theme-xs h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 pr-11 text-sm"
                                    >
                    ...
                    {{--
                        ...
                        <div
                        class="w-full col-span-4 bg-white border border-gray-200 rounded-2xl dark:border-gray-800 dark:bg-white/5 h-fit"
                        >
                    --}}
                    <div class="px-5 py-4 sm:px-6 sm:py-5">
                        <h3 class="text-base font-medium text-gray-800 dark:text-white/90">Komunitas</h3>
                    </div>
                    <div class="p-5 space-y-6 border-t border-gray-100 sm:p-6 dark:border-gray-800">
                        <div class="flex flex-wrap items-center gap-6 sm:gap-8">
                            <template x-for="community in communities" :key="community.id">
                                <div
                                    x-data="{
                                        isChecked: selectedCommunityIds.includes(community.id),
                                    }"
                                >
                                    <label class="flex items-center gap-3 text-sm font-medium cursor-pointer">
                                        <div class="relative">
                                            <input
                                                ...
                                                name="community_ids[]"
                                                :value="community.id"
                                                x-model="selectedCommunityIds"
                                                @change="isChecked = $event.target.checked"
                                            />

                                            <!-- TRACK -->
                                            <div
                                                :class="isChecked ? 'bg-blue-600' : 'bg-gray-700'"
                                                class="block h-6 transition rounded-full w-11"
                                            ></div>

                                            <!-- THUMB -->
                                            <div
                                                :class="isChecked ? 'translate-x-full' : 'translate-x-0'"
                                                class="absolute top-0.5 left-0.5 h-5 w-5 bg-white rounded-full transition-transform"
                                            ></div>
                                        </div>

                                        <span x-text="community.nama"></span>
                                    </label>
                                </div>
                            </template>

                            <template x-if="communities.length === 0">
                                <p class="text-sm text-gray-500">Tidak ada komunitas</p>
                            </template>
                        </div>
                    </div>
                </div>
    ...
    <script>
        function sectionForm() {
            return {
                ...
                interestId: '{{ old("interest_id") }}',
                subInterestId: '{{ old("sub_interest_id") }}',

                interests: [],
                subInterests: [],

                loadingInterest: false,
                loadingSubInterest: false,

                work_id: '{{ old("work_id") }}',
                works: [],

                metafields: @js($metafieldUsers),
                loadingMetafield: false,

                communities: [],
                selectedCommunityIds: @js(old("community_ids", isset($data) ? $data->communities->pluck("id")->toArray() : [])),
                ...
                async fetchCommunities() {
                    ...
                    const res = await fetch(`/api/get-communities-by-zone/${this.zone_id}`);
                ...
                async fetchMetafields() {
                    ...
                    try {
                        const res = await fetch(`/api/get-metafields_user/${this.zone_id}`);
                ...
                async fetchInterests() {
                    ...
                    try {
                        const res = await fetch(`/api/get-interests-by-zone/${this.zone_id}`);
                        this.interests = await res.json();
                        this.interestId = this.interests?.[0]?.id || null;
