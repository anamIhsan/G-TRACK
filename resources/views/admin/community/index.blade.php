...
@section("title", "ADMIN | Data Komunitas")
            ...
            <div class="space-y-5 sm:space-y-6">
                ...
                >
                    <div class="flex flex-col gap-2 mb-4 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">Daftar Komunitas</h3>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center gap-2">
                                                <a
                                                    href="{{ route("admin.communities.edit", $item->id) }}"
                                                ...
                                                <form
                                                    ...
                                                    action="{{ route("admin.communities.destroy", $item->id) }}"
                                                    method="POST"
                                                >
                                                    @csrf
                                                    @method("DELETE")
