...
@section('title', 'ADMIN | Tambah Daerah')

@section('content')
    <div class="grid grid-cols-12 gap-4 md:gap-6">
        <form action="{{ route('admin.zones.store') }}" method="POST" class="col-span-12">
            @csrf
            @method('POST')
            <div class="flex">
                <div class="w-full bg-white border border-gray-200 rounded-2xl dark:border-gray-800 dark:bg-white/5">
                    <div class="px-5 py-4 sm:px-6 sm:py-5">
                        <h3 class="text-base font-medium text-gray-800 dark:text-white/90">Tambah Daerah</h3>
                    </div>
                    <div class="p-5 space-y-6 border-t border-gray-100 sm:p-6 dark:border-gray-800">
                        <div>
                            ...
                            <input value="{{ old('nama') }}" name="nama" type="text" placeholder="Cth: Lombok"
                        ...
                        <div>
                            ...
                            <input value="{{ old('admin_nama') }}" name="admin_nama" type="text"
                        ...
                        <div>
                            ...
                            <input value="{{ old('no_tlp') }}" name="no_tlp" id="no_tlp" type="text"
                        ...
                        <div>
                            ...
                            <input value="{{ old('email') }}" name="email" type="email" value="{{ old('email') }}"
