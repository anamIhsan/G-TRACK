        ...
        <div class="flex flex-col gap-2 mb-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex flex-row flex-wrap items-center gap-3">
                @if (in_array($authData->role, ['MASTER', 'ADMIN_DAERAH']))
                    <a href="{{ route('admin.cards.twibbon.create') }}"
                ...
                <a href="{{ isset($twibbon) && $twibbon != null ? route('admin.cards.twibbon.download.all', isset($filters) ? $filters : '') : '#' }}"
                ...
                <div class="grid grid-cols-1 gap-3 mt-5 space-y-5 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                    ...
                    <div>
                        ...
                        <select name="kelamin"
                            ...
                            <option {{ isset($filters['kelamin']) ? ($filters['kelamin'] == 'LK' ? 'selected' : '') : '' }}
                                value="LK">
                                Laki-laki
                            </option>
                            <option {{ isset($filters['kelamin']) ? ($filters['kelamin'] == 'PR' ? 'selected' : '') : '' }}
                                value="PR">
                                Perempuan
                            </option>
                        </select>
                ...
                @forelse ($users as $item)
                    <div x-data x-init="new QRCode($refs.qrcode, {
                        ...
                        <div
                            ...
                            <div class="flex flex-col">
                                <div class="relative">
                                    <img src="{{ isset($item->twibbon_user) ? $item->twibbon_user : '' }}"
                                        alt="Twibbon" />
                                </div>
                                <div class="flex flex-row items-center gap-3 mt-4">
                                    <a href="{{ route('admin.cards.twibbon.download', $item->id) }}"
                                        class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-white transition rounded-lg bg-brand-500 hover:bg-brand-600 shadow-theme-xs">
                                        <i class="fa-solid fa-download"></i>
                                        Unduh
                                    </a>
