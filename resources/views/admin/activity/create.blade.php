...
@section('content')
    <div class="grid grid-cols-12 gap-4 md:gap-6">
        <form x-data="sectionForm()" x-init="init()" action="{{ route('admin.activities.store') }}" method="POST"
            ...
            <div class="flex flex-col gap-2 space-y-5 md:flex-row sm:space-y-6">
                <div class="w-full bg-white border border-gray-200 rounded-2xl dark:border-gray-800 dark:bg-white/5">
                    <div class="px-5 py-4 sm:px-6 sm:py-5">
                        <h3 class="text-base font-medium text-gray-800 dark:text-white/90">Tambah Kegiatan</h3>
                    </div>
                    <div class="p-5 space-y-6 border-t border-gray-100 sm:p-6 dark:border-gray-800">
                        ...
                        <div>
                            ...
                            <input value="{{ old('no_pj') }}" name="no_pj" id="no_pj" type="text"
                                class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                        </div>
                        ...
                        <div>
                            ...
                            <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                                <select name="type"
                                    ...
                                    <option {{ old('type') === 'SEKALI' ? 'selected' : '' }} value="SEKALI"
                                        class="text-gray-700 dark:bg-gray-900 dark:text-gray-400" selected>
                                        Sekali
                                    </option>
                                    <option {{ old('type') === 'TERJADWAL' ? 'selected' : '' }} value="TERJADWAL"
                        ...
                        <div x-transition x-show="type === 'SEKALI'">
                            ...
                            <div class="relative">
                                <input value="{{ old('tanggal') }}" name="tanggal" type="date" placeholder="Select date"
                        ...
                        <div x-transition x-show="type === 'TERJADWAL'">
                            ...
                            <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                                <select name="hari"
                                    ...
                                    <option {{ old('hari') === '1' ? 'selected' : '' }} value="1"
                                        class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                        Senin
                                    </option>
                                    <option {{ old('hari') === '2' ? 'selected' : '' }} value="2"
                                        class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                        Selasa
                                    </option>
                                    <option {{ old('hari') === '3' ? 'selected' : '' }} value="3"
                                        class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                        Rabu
                                    </option>
                                    <option {{ old('hari') === '4' ? 'selected' : '' }} value="4"
                                        class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                        Kamis
                                    </option>
                                    <option {{ old('hari') === '5' ? 'selected' : '' }} value="5"
                                        class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                        Jumat
                                    </option>
                                    <option {{ old('hari') === '6' ? 'selected' : '' }} value="6"
                                        class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                        Sabtu
                                    </option>
                                    <option {{ old('hari') === '7' ? 'selected' : '' }} value="7"
                                        class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                        Minggu
                                    </option>
                                </select>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input value="{{ old('jam') }}" name="jam" type="time" placeholder="12:00 AM"
                                    onclick="this.showPicker()"
                                    class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 pr-11 pl-4 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                        ...
                        <div>
                            ...
                            <input value="{{ old('materi') }}" name="materi" type="text"
                                class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                        </div>
                        <div>
                            <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                            ...
                                            <label for="togel{{ $age_category->id }}"
                                                ...
                                                <div class="relative">
                                                    <input name="age_category_ids[]" value="{{ $age_category->id }}"
                                                        ...
                                                        {{ $age_category->id === old('age_category_ids') ? 'checked' : '' }} />
