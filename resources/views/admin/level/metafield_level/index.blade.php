...
@section("title", "ADMIN | Materi Tingkat Kekhataman")
            ...
            <div class="space-y-5 sm:space-y-6">
                ...
                >
                    <div class="flex flex-col gap-2 mb-4 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <div class="flex items-center">
                            <a
                                ...
                                href="{{ route("admin.metafield_level.create") }}"
                            >
                    ...
                    <div class="w-full overflow-x-auto">
                        <table class="min-w-full whitespace-nowrap">
                            ...
                            <thead>
                                <tr class="border-gray-100 border-y dark:border-gray-800">
                                    <th
                                        class="py-3 pr-5 font-medium text-left text-gray-500 text-theme-xs dark:text-gray-400"
                                    >
                                        No.
                                    </th>
                                    <th
                                        class="py-3 pr-32 font-medium text-left text-gray-500 text-theme-xs dark:text-gray-400"
                                    >
                                        Nama Tingkatan Kekhataman
                                    </th>
                                    <th
                                        class="py-3 pr-32 font-medium text-left text-gray-500 text-theme-xs dark:text-gray-400"
                                    >
                            ...
                            <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                                @forelse ($metafieldLevels as $item)
                                    <tr class="transition-colors hover:bg-gray-50 dark:hover:bg-white/5">
                                        ...
                                        <td class="py-3 text-gray-500 text-theme-sm dark:text-gray-400">
                                            {{ $item->field_name ?? "Tidak diatur" }}
                                        </td>

                                        <td class="py-3 text-gray-500 text-theme-sm dark:text-gray-400">
                                            {{ $item->halaman ?? "Tidak diatur" }}
                                        </td>
                                        ...
                                        <td class="py-3">
                                            <div class="flex items-center gap-2">
                                                <a
                                                    type="button"
                                                    href="{{ route("admin.metafield_level.edit", $item->id) }}"
                                                ...
                                                <form
                                                    ...
                                                    action="{{ route("admin.metafield_level.destroy", $item->id) }}"
                                                    method="POST"
                                                >
                                                    @csrf
                                                    @method("DELETE")
                        ...
                        <x-pagination :data="$metafieldLevels" />
                    </div>
                </div>
            </div>
        </div>
