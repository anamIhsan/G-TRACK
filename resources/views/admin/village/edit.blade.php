...
@section("title", "ADMIN | Edit Desa")

@section("content")
    <div class="grid grid-cols-12 gap-4 md:gap-6">
        <form
            action="{{ route("admin.villages.update", $data->id) }}"
            method="POST"
            ...
            <div class="flex">
                <div class="w-full bg-white border border-gray-200 rounded-2xl dark:border-gray-800 dark:bg-white/5">
                    <div class="px-5 py-4 sm:px-6 sm:py-5">
                        <h3 class="text-base font-medium text-gray-800 dark:text-white/90">Edit Desa</h3>
                    </div>
                    ...
                    <div class="p-5 space-y-6 border-t border-gray-100 sm:p-6 dark:border-gray-800">
                        ...
                        <div>
                            ...
                            <input
                                name="admin_nama"
                                type="text"
                                value="{{ old("admin_nama", $data->admin?->nama) }}"
                        ...
                        <div>
                            ...
                            <input
                                ...
                                id="no_tlp"
                                type="text"
                                value="{{ old("no_tlp", $data->admin?->no_tlp) }}"
                        ...
                        <div>
                            ...
                            <input
                                name="email"
                                type="email"
                                value="{{ old("email", $data->admin?->email) }}"
                        ...
                        <div>
                            ...
                            <div x-data="{ showPassword: false }" class="relative">
                                <input
                                    ...
                                    placeholder="Masukan password jika ingin diganti"
                                    name="password"
