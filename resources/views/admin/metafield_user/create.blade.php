...
@section("title", "ADMIN | Tambah Custom Kolom Pengguna")

@section("content")
    <div class="grid grid-cols-12 gap-4 md:gap-6">
        <form
            x-data="sectionForm()"
            action="{{ route("admin.metafield_user.store") }}"
            method="POST"
            class="col-span-12"
        >
            @csrf
            ...
            <div class="flex">
                <div class="w-full bg-white border border-gray-200 rounded-2xl dark:border-gray-800 dark:bg-white/5">
                    ...
                    <div class="p-5 space-y-6 border-t border-gray-100 sm:p-6 dark:border-gray-800">
                            ...
                            <div class="ml-2" x-transition x-show="type === 'ENUM'">
                                ...
                                >
                                    ...
                                    <div class="flex w-full gap-1">
                                        ...
                                        <button
                                            x-show="type === 'ENUM'"
                                            @click="if (inputs.length > 2) inputs.splice(index, 1)"
                                            ...
                                            :class="inputs.length <= 2 ? 'bg-red-200 cursor-not-allowed' : 'bg-red-500 hover:bg-red-600'"
                                        >
                        ...
                        <div x-show="type === 'ENUM'" class="flex flex-row justify-between">
                            <div></div>
                            <button
                                @click="inputs.push('')"
                                type="button"
            ...
            <div class="flex items-center gap-3 mt-4">
                <a
                    href="{{ route("admin.metafield_user.index") }}"
